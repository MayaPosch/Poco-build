...
all: foundation crypto util net netssl json data data-sqlite
...
clean: clean-json clean-foundation clean-net clean-netssl clean-util clean-data clean-data-sqlite clean-crypto
